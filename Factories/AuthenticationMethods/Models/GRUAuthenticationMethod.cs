...
{
    public class GRUAuthenticationMethod : AuthenticationMethod
    {
        private readonly MLAuthenticationRequestService _mlAuthService;

        public GRUAuthenticationMethod(
            List<double> userKeyPressedTimes,
            List<double> userBetweenKeysTimes,
            List<List<double>> userKeyPressedTimesProfile,
            List<List<double>> userBetweenKeysTimesProfile) : base(userKeyPressedTimes, userBetweenKeysTimes, userKeyPressedTimesProfile, userBetweenKeysTimesProfile)
        {
