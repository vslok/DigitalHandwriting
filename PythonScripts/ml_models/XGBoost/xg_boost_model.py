...
class KeystrokeXGBoost:
    ...
    def _open_results_file(self):
        ...
        results_path = os.path.join(RESULTS_DIR, f'xgboost_model_results_{timestamp}.txt')
    ...
    def train_and_validate(self, tune_hyperparameters=False):
        ...
        self._write_to_results("Starting XGBoost model training and validation...\n")
...
def main():
    xgb = KeystrokeXGBoost()
    print("Training and validating XGBoost models...")
